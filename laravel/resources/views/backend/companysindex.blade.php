                ...
                @foreach ($items as $key => $item)
                      <tr class="{{ $item->is_active == 0? 'danger' : '' }}">
                          ...
                          <td style="text-align:center;">
                              ...
                              <?php
                                $confirmdelete = trans('messages.confirm_delete', ['attribute' => $item->users_company_th]);
                              ?>
                              {!! Form::open(['method' => 'DELETE','route' => ['companys.destroy', $item->id],'style'=>'display:inline']) !!}
