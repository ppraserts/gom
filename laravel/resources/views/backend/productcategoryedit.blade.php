...
if($mode=="create")
{
  $method = "POST";
  $formModelId = 0;
  $controllerAction = "productcategory.store";
}
else
{
  $method = "PATCH";
  $formModelId =  $item->id;
  $controllerAction = "productcategory.update";
}
?>
...
<div class="col-sm-12">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-default" href="{{ route('productcategory.index') }}">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group {{ $errors->has('productcategory_description_th') ? 'has-error' : '' }}">
                <strong>{{ Lang::get('validation.attributes.productcategory_description_th') }}:</strong>
                {!! Form::textarea('productcategory_description_th', null, array('placeholder' => Lang::get('validation.attributes.productcategory_description_th'),'class' => 'form-control','style'=>'height:100px')) !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group {{ $errors->has('productcategory_description_en') ? 'has-error' : '' }}">
                <strong>{{ Lang::get('validation.attributes.productcategory_description_en') }}:</strong>
                {!! Form::textarea('productcategory_description_en', null, array('placeholder' => Lang::get('validation.attributes.productcategory_description_en'),'class' => 'form-control','style'=>'height:100px')) !!}
            </div>
        </div>
