...
@section('content')
    ...
    <br/>
    <form enctype="multipart/form-data" class="form-inline" role="form" method="post" action="{{ url('user/productbuyedit/'.$item->id) }}">
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group col-md-6 {{ $errors->has('productcategorys_id') ? 'has-error' : '' }}">
                    ...
                    <select id="productcategorys_id" name="productcategorys_id" class="form-control min-width-100pc">
                ...
                @if(isset($standards))
                    <div class="form-group col-md-6 pd-top-10">
                        <strong style="display: block; padding-bottom: 5px;"> {{ trans('validation.attributes.guarantee') }} :</strong>
                ...
                <div id="div_packing_size" class="form-group col-md-6 pd-top-10 {{ $errors->has('packing_size') ? 'has-error' : '' }}">
        ...
        <div class="row">
            ...
            <div class="form-group pd-top-10 {{ $errors->has('product_description') ? 'has-error' : '' }}">
