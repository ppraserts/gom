                            ...
                            <div class="row">
                                ...
                                <div class="rating hidden-sm col-md-4">
                                    @if($col_md_4_item['Colors']!="white")
                                        <span title="{{ $col_md_4_item['Colors'] == 'green' ? trans('messages.green_condition') : trans('messages.red_condition') }}"
                                              class="glyphicon glyphicon-record" aria-hidden="true"
                                              style=" color: {{ $col_md_4_item['Colors']  }};"></span>
                                    @endif
                                </div>
