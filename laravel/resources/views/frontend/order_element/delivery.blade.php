    ...
    <div class="row" style="padding: 17px 15px;">
        ...
        <form action="{{url('user/orderdetail/store-status-history')}}" id="delivery_form" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group ">
                ...
                <?php
                $shipping_channel = $order->delivery_chanel;
                if(!empty($order_delivery->shipping_channel)){
                    $shipping_channel = $order_delivery->shipping_channel;
                }
                ?>
                <input type="text" disabled  value="{{$shipping_channel}}" class="form-control disabled" style="margin-bottom: 5px; width: 320px;">
                <input type="hidden" id="delivery_chanel" name="delivery_chanel" value="{{$shipping_channel}}" class="form-control" style="margin-bottom: 5px; width: 320px;">
